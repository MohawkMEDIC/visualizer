...
namespace MARC.EHRS.VisualizationServer.KnowledgeBase.Configuration
{
    /// <summary>
    ...
    public class ConfigurationHandler : IConfigurationSectionHandler
    {
        ...
        public object Create(object parent, object configContext, System.Xml.XmlNode section)
        {
            ...
            // Allow post?
            connectionManagerConfig = section.SelectSingleNode("./*[local-name() = 'allow']");
            if (connectionManagerConfig != null)
            {
                if (connectionManagerConfig.Attributes["post"] != null)
                    this.AllowPost = Convert.ToBoolean(connectionManagerConfig.Attributes["post"].Value);
                else
