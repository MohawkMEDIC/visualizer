...
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110100','DCM','Application Activity');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110101','DCM','Audit Log Used');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110102','DCM','Begin Transferring DICOM Instances ');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110103','DCM','DICOM Instances Accessed');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110104','DCM','DICOM Instances Transferred');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110105','DCM','DICOM Study Deleted');
...
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110113','DCM','Security Alert');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110114','DCM','User Authentication');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110120','DCM','Application Start');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110121','DCM','Application Stop');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110122','DCM','Login');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110123','DCM','Logout');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110124','DCM','Attach');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110125','DCM','Detach');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110126','DCM','Node Authentication');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110127','DCM','Emergency Override Started');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110132','DCM','Use of a restricted function');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110135','DCM','Object Security Attributes Changed');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110136','DCM','Security Roles Changed');
INSERT INTO CD_TBL (CD_MNEMONIC, CD_DOMAIN, CD_DISPLAY) VALUES ('110137','DCM','User security Attributes Changed');
...
(
	...
	CONSTRAINT FK_AUD_MSG_SNDR_PROC_VRSN_ID_PROC_VRSN_TBL FOREIGN KEY (SNDR_PROC_VRSN_ID) REFERENCES PROC_VRSN_TBL(PROC_VRSN_ID)
);
...
(
	...
	MSG_VRSN_ID	DECIMAL(20,0) NOT NULL, -- THE MESSAGE FROM WHICH THIS AUDIT IS PARSED
	...
	CONSTRAINT FK_AUD_EVT_MSG_VRSN_ID_MSG_VRSN_TBL FOREIGN KEY (MSG_VRSN_ID) REFERENCES AUD_MSG_VRSN_TBL(MSG_VRSN_ID),
...
-- PHYSICAL NODE
CREATE TABLE AUD_ENT_SRC_ENT_STE_TBL
(
	SRC_ID				DECIMAL(20,0) NOT NULL, -- THE ENTERPRISE SOURCE IDENTIFIER
	...
	CONSTRAINT PK_AUD_ENT_SRC_ENT_STE_TBL PRIMARY KEY (STE_ID, SRC_EFFT_VRSN_ID),
	CONSTRAINT FK_AUD_ENT_SRC_ENT_STE_STE_AUD_ENT_STE_TBL FOREIGN KEY (STE_ID) REFERENCES AUD_ENT_STE_TBL(STE_ID),
	CONSTRAINT FK_AUD_ENT_SRC_ENT_STE_SRC_ID_AUD_ENT_SRC_TBL FOREIGN KEY (SRC_ID) REFERENCES AUD_ENT_SRC_TBL(SRC_ID),
	CONSTRAINT FK_AUD_ENT_SRC_ENT_STE_SRC_EFFT_VRSN_ID_AUD_ENT_SRC_VRSN_TBL FOREIGN KEY (SRC_EFFT_VRSN_ID) REFERENCES AUD_ENT_SRC_VRSN_TBL(SRC_VRSN_ID),
	CONSTRAINT FK_AUD_ENT_SRC_ENT_STE_SRC_OBSLT_VRSN_ID_AUD_ENT_SRC_VRSN_TBL FOREIGN KEY (SRC_OBSLT_VRSN_ID) REFERENCES AUD_ENT_SRC_VRSN_TBL(SRC_VRSN_ID)
);

-- @INDEX
-- AUDIT ENTERPRISE SITE VERSION INDEX
CREATE INDEX AUD_ENT_STE_SRC_VRSN_IDX ON AUD_ENT_SRC_ENT_STE_TBL(SRC_EFFT_VRSN_ID, SRC_OBSLT_VRSN_ID);
...
(
	...
	NODE_VRSN_ID		DECIMAL(20,0), -- THE NODE THAT THE PARTICIPANT WAS USING
